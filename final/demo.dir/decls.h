...
struct model_struct {
	System* $sys;
	ordlist* am_OL_notvip;
	rnstream* am_stream_R_normal2_1;
	process* am_P_dummy;
	process* am_die;
	rnstream* am_stream_R_normal1_1;
	variable* am_V_normal1$var;
	int32 am_V_normal1;
	rnstream* am_stream_L_vip_1;
	resource* am_R_normal1;
	variable* am_OPCTimestamp$var;
	char* am_OPCTimestamp;
	process* am_P_notvipwork;
	process* am_P_notvip;
	queue* am_Q_vipwait;
	System* am_modelsys;
	queue* am_Space;
	queue* am_Q_notvipwait;
	ordlist* am_OL_vip;
	rnstream* am_stream_L_dummy_1;
	rnstream* am_stream0;
	resource* am_R_normal3;
	variable* am_V_normal3$var;
	int32 am_V_normal3;
	process* am_P_vipwork;
	struct model_conv_struct am_conv;
	rnstream* am_stream_R_normal4_1;
	resource* am_R_normal2;
	variable* am_V_normal2$var;
	int32 am_V_normal2;
	process* am_P_vip;
	resource* am_R_vip;
	variable* am_V_vip$var;
	int32 am_V_vip;
	rnstream* am_stream_R_normal3_1;
	rnstream* am_stream_R_vip_1;
	variable* am_OPCQuality$var;
	int32 am_OPCQuality;
	resource* am_R_normal4;
	ContainerDef* am_Container1;
	variable* am_V_normal4$var;
	int32 am_V_normal4;
	rnstream* am_stream_L_notvip_1;
};
